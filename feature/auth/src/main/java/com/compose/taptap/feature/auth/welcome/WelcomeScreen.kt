...
import com.compose.taptap.feature.auth.Provider
...
fun WelcomeScreen() {
    ...
    Box(
        ...
        Column(
            ...
            ThirdLoginSection(
                authState = authState,
                onFacebookSignIn = { viewModel.onEvent(WelcomeEvent.OnFacebookSignIn) },
                onGoogleSignIn = { viewModel.onEvent(WelcomeEvent.OnGoogleSignIn) }
            )
